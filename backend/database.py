...
def seed_default_banks_and_admins():
    ...
    try:
        ...
        # 2. Global System Administrator (Super Admin across all partner banks)
        ...
        if not existing_admin:
            ...
            admin = User(
                full_name="CrediWise System Administrator",
            ...
            existing_admin.full_name = "CrediWise System Administrator"
